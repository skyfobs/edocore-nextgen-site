      ...
      {/* Stats Grid */}
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Stat Card 1 */}
            <div className="bg-[#003366] border border-[#003366] p-6 rounded-lg hover:bg-white hover:shadow-lg transition-all duration-300 group">
              <div className="w-12 h-12 rounded-lg bg-white/10 flex items-center justify-center mb-6 group-hover:bg-[#003366] transition-colors">
              ...
              <div className="text-5xl font-bold text-white group-hover:text-[#001e40] mb-2 transition-colors">3000+</div>
              <div className="text-sm font-semibold text-white group-hover:text-[#003366] uppercase tracking-wide transition-colors">Enrolled Students</div>
              <div className="mt-3 h-1 w-12 bg-white group-hover:bg-[#003366] transition-colors"></div>
            </div>
            ...
            <div className="bg-[#003366] border border-[#003366] p-6 rounded-lg hover:bg-white hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="text-5xl font-bold text-white group-hover:text-[#001e40] mb-2 transition-colors">2800+</div>
              <div className="text-sm font-semibold text-white group-hover:text-[#003366] uppercase tracking-wide transition-colors">Passed Graduates</div>
              <div className="mt-3 h-1 w-12 bg-white group-hover:bg-[#003366] transition-colors"></div>
            </div>
            ...
            <div className="bg-[#003366] border border-[#003366] p-6 rounded-lg hover:bg-white hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="text-5xl font-bold text-white group-hover:text-[#001e40] mb-2 transition-colors">70+</div>
              <div className="text-sm font-semibold text-white group-hover:text-[#003366] uppercase tracking-wide transition-colors">Courses Offered</div>
              <div className="mt-3 h-1 w-12 bg-white group-hover:bg-[#003366] transition-colors"></div>
            </div>
            ...
            <div className="bg-[#003366] border border-[#003366] p-6 rounded-lg hover:bg-white hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="text-5xl font-bold text-white group-hover:text-[#001e40] mb-2 transition-colors">9+</div>
              <div className="text-sm font-semibold text-white group-hover:text-[#003366] uppercase tracking-wide transition-colors">Academic Partners</div>
              <div className="mt-3 h-1 w-12 bg-white group-hover:bg-[#003366] transition-colors"></div>
            </div>
          </div>
        </div>
